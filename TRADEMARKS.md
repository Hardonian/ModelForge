# Trademark & Brand Attribution Guidelines
...
- **Hugging Face® and 🤗** are trademarks of Hugging Face, Inc.
- **AMD®, ROCm™, and Instinct™** are trademarks of Advanced Micro Devices, Inc.
- **Apple®, Apple Silicon®, Metal®, and macOS®** are trademarks of Apple Inc., registered in the U.S. and other countries.
- **Linux®** is the registered trademark of Linus Torvalds.
- **Llama®** is a trademark of Meta Platforms, Inc.
- **Qwen™** is a trademark of Alibaba Cloud Computing Co., Ltd.
- **DeepSeek™** is a trademark of Hangzhou DeepSeek Artificial Intelligence Co., Ltd.
- **Mistral™** is a trademark of Mistral AI SAS.
- **Gemma™** is a trademark of Google LLC.

ModelForge is an independent open-source project and is not officially affiliated with, endorsed by, or sponsored by any of the trademark owners listed above unless explicitly stated in formal partner agreements.
